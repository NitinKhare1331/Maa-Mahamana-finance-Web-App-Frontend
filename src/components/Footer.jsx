const Footer = () => {
    ...
    return (
        ...
        <div className="cursor-pointer border-t border-gray-300 text-center py-4 text-sm text-gray-500">
            Handcrafted with Lov<span className="cursor-pointer text-red-500">❤️</span> in Bharat
        </div>
        </footer>
    );
};
