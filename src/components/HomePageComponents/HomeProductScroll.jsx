...
const HomeProductScroll = () => {
    return (
        <div className="max-w-6xl mx-auto px-4 py-10">
            ...
            <div className="overflow-y-hidden pb-4 overflow-x-auto scrollbar-custom">
                <div className="flex gap-4 min-w-max">
                    ...
                    <motion.div
                        ...
                        className="max-w-[280px] mt-4 ml-1 mr-1 bg-white rounded-xl p-5 border hover:border-indigo-600 transition-all duration-300 shadow-sm hover:shadow-md cursor-pointer"
                    >
                        {item.label && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <motion.div
                    ...
                    variants={cardVariants}
                    whileHover={{ scale: 1.03 }}
                    className="bg-white rounded-xl p-5 border hover:border-indigo-600 transition-all duration-300 shadow-sm hover:shadow-md cursor-pointer"
                >
                    {item.label && (
                    <div className="text-xs bg-green-100 text-green-700 w-fit px-2 py-0.5 rounded mb-2 font-medium">
                        {item.label}
